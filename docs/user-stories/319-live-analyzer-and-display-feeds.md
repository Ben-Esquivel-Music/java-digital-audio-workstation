...
- The docked "Spectrum" and "Peak / RMS" panels are the idle-animator-fed "decorative shells" (`MainController.java:875-876`, dock registration `:2748`): `AnimationController.java:120` ticks `IdleVisualizationAnimator` unconditionally, pushing a sine-phase spectrum every frame (`IdleVisualizationAnimator.java:55-62`) — during playback and recording.
