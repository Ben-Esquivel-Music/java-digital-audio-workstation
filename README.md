...
![DAW Main Session View](docs/screenshots/session-view.png)
...
![DAW Mixer and Recording View](docs/screenshots/mixer-view.png)
...
![DAW Sound Wave Telemetry View](docs/screenshots/telemetry-view.png)
