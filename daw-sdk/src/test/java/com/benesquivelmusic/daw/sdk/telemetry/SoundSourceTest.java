...
class SoundSourceTest {
    ...
    void shouldCreateWithValidParameters() {
        Position3D pos = new Position3D(5.0, 4.0, 1.0);
        SoundSource source = new SoundSource("Guitar Amp", pos, 85.0);
    ...
    void shouldAllowNegativePowerDb() {
        SoundSource source = new SoundSource("Quiet", new Position3D(0, 0, 0), -10.0);
