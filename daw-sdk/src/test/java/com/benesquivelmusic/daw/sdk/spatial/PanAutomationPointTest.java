...
class PanAutomationPointTest {
    ...
    void shouldCreateValidPoint() {
        PanAutomationPoint point = new PanAutomationPoint(4.0, 90.0, 30.0, 1.5);
    ...
    void shouldConvertToSpatialPosition() {
        PanAutomationPoint point = new PanAutomationPoint(0, 45.0, 10.0, 2.0);
        SpatialPosition pos = point.toSpatialPosition();
    ...
    void shouldNormalizeAzimuthInConversion() {
        PanAutomationPoint point = new PanAutomationPoint(0, -90.0, 0, 1.0);
        SpatialPosition pos = point.toSpatialPosition();
