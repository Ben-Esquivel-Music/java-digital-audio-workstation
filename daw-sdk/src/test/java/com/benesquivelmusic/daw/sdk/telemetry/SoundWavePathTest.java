...
class SoundWavePathTest {
    ...
    void shouldCreateDirectPath() {
        Position3D src = new Position3D(0, 0, 0);
        Position3D mic = new Position3D(3, 4, 0);
        SoundWavePath path = new SoundWavePath("Guitar", "Mic1", List.of(src, mic), 5.0, 14.58, -13.98, false);
    ...
    void shouldCreateReflectedPath() {
        Position3D src = new Position3D(0, 0, 0);
        Position3D wall = new Position3D(5, 2, 0);
        Position3D mic = new Position3D(3, 4, 0);
        SoundWavePath path = new SoundWavePath("Guitar", "Mic1", List.of(src, wall, mic), 8.0, 23.3, -18.0, true);
    ...
    void shouldReturnDefensiveCopyOfWaypoints() {
        java.util.ArrayList<Position3D> waypoints = new java.util.ArrayList<>(List.of(
                new Position3D(0, 0, 0), new Position3D(1, 1, 1)));
        SoundWavePath path = new SoundWavePath("Src", "Mic", waypoints, 1.0, 1.0, -5.0, false);
