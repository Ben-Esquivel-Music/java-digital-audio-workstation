...
/**
 * Golden-file regression test for {@link ParametricEqProcessor}. Exercises the
 ...
 * goldens with {@code mvn -Pdsp-rebaseline test -Dtest=ParametricEqProcessorRegressionTest}.</p>
 */
class ParametricEqProcessorRegressionTest {
    ...
    void parametricEq_sineSweep_allPresets() throws Exception {
