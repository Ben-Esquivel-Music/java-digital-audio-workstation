...
public final class EditorView extends VBox {
    ...
    private VBox buildMidiEditor() {
        ...
        pianoRollCanvas.setWidth(PIANO_KEY_WIDTH + GRID_COLUMNS * 20);
        ...
        velocityCanvas.setWidth(PIANO_KEY_WIDTH + GRID_COLUMNS * 20);
    ...
    /**
     * Renders the piano roll grid on the canvas.
     */
