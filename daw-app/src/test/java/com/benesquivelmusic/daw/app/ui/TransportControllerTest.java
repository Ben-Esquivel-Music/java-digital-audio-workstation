...
class TransportControllerTest {
    ...
    void shouldFormatZeroAsAllZeros() {
        assertThat(TransportController.formatTime(0)).isEqualTo("00:00:00.0");
    }
    ...
    void shouldFormatTimeCorrectly(long nanos, String expected) {
        assertThat(TransportController.formatTime(nanos)).isEqualTo(expected);
    }
    ...
    void shouldFormatSubSecondTenths() {
        ...
        assertThat(TransportController.formatTime(nanos)).isEqualTo("00:00:01.3");
    }
    ...
    void shouldFormatMinutesAndSeconds() {
        ...
        assertThat(TransportController.formatTime(nanos)).isEqualTo("00:02:30.0");
    }
    ...
    void shouldFormatHoursMinutesSeconds() {
        ...
        assertThat(TransportController.formatTime(nanos)).isEqualTo("01:15:42.7");
    }
    ...
    void shouldTruncateMillisecondsToTenths() {
        ...
        assertThat(TransportController.formatTime(nanos)).isEqualTo("00:00:00.9");
    }
}
